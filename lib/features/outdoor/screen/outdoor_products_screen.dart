...
class OutdoorProductsScreen extends StatelessWidget {
  const OutdoorProductsScreen({super.key});
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() {
          ...
          var outdoorProducts = controller.allItem
              .where((product) => product.category.toLowerCase() == 'outdoor')
              .toList();
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Check back later for outdoor products',
                    style: TextStyle(
                      fontSize: 14,
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Products count
                Text(
                  '${outdoorProducts.length} Outdoor Products Found',
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.grey[600],
                    fontWeight: FontWeight.w500,
